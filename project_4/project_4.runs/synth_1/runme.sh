...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SwitchDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SwitchDriver.tcl

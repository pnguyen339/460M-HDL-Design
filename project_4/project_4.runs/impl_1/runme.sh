...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SwitchDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SwitchDriver.tcl -notrace

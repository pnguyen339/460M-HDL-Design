...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sub4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sub4.tcl

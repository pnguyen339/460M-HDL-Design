...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sub4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sub4.tcl -notrace

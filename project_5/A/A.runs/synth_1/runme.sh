...
HD_PWD='E:/Users/Peter Nguyen/Documents/GitHub/460M-HDL-Design/project_5/A/A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardInput.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyboardInput.tcl

...
HD_PWD='C:/Users/erick/Documents/GitHub/460M-HDL-Design/project_5/B/460M_Lab6/460M_Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseGen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PulseGen.tcl -notrace

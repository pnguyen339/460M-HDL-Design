...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LightController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LightController.tcl

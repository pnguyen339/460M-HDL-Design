...
HD_PWD='D:/Users/pnguy/Documents/GitHub/460M-HDL-Design/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LightController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LightController.tcl -notrace

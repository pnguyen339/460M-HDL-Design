...
HD_PWD='/home/dratini/vivado/460M-HDL-Design/project_0/project_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder4.tcl -notrace
